...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Big J’s Treefelling",
    phone:     "+27 76 429 3601",
    whatsapp:  "+27 76 429 3601",
    address:   "32 Rutland Ave, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Big J’s Treefelling — Tree felling in randburg",
    description: "Big J’s Treefelling provides professional tree felling in Randburg. 1 Google review. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Tree felling · Randburg & surrounds",
    heroTitle:  "Safe tree felling — <em>from assessment to clean-up.</em>",
    heroLead:   "Big J’s Treefelling handles tree felling, stump removal and trimming across Randburg and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "Big J’s Treefelling team at work in Randburg",
      text:  "Safe, efficient tree felling — from assessment to clean-up."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Randburg. Covering the wider area.",
    areasLead:  "We work across Randburg, Northcliff, Cresta and the surrounding suburbs. Emergency callouts for storm damage handled as quickly as possible.",
